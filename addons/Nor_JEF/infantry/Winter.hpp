 class BNB_FA_Nor_Rifleman_Winter: B_Soldier_F
  {
    faction="BNB_Nor_UK_Faction";
  ...
  class BNB_Nor_UK_Medic_Winter: B_medic_F
  {
    ...
    linkedItems[]={"ItemMap","ItemCompass","ItemWatch","TFAR_anprc152","ItemGPS","PB_M05W_H","UK3CB_BAF_V_Osprey_Winter"};
    respawnLinkedItems[]={"ItemMap","ItemCompass","ItemWatch","TFAR_anprc152","ItemGPS","PB_M05W_H","UK3CB_BAF_V_Osprey_Winter"};
    backpack="BNB_FA_Nor_Medic_Winter_pack";
  };

  class BNB_FA_Nor_IC_Winter: B_Soldier_SL_F
  {
    faction="BNB_FA_Nor_Faction";
    editorSubcategory="BNB_FA_Nor_Winter";
    side=1;
    ...
    backpack="BNB_FA_Nor_IC_Winter_pack";
  };


  class BNB_FA_Nor_Rifleman_Winter_pack: PB_BP01_Schneetarn
  {
    scope=2;
  ...
  class BNB_FA_Nor_Medic_Winter_pack: PB_BP01_Schneetarn
  {
    scope=2;
    class TransportMagazines{};
    class TransportItems
  ...
  class BNB_FA_Nor_IC_Winter_pack: PB_RT1523BIG_SCHNEE
  {
    scope=2;
    class TransportMagazines
    {
