...
class CfgVehicles {
	...
	class BNB_FA_RS_Autorifleman : O_Soldier_AR_F_OCimport_02 {
		...
		class EventHandlers : EventHandlers {
			...
			class ALiVE_orbatCreator {
				init = "if (local (_this select 0)) then {_unit = _this select 0;_onSpawn = {_unit = _this select 0;_unit setUnitLoadout [['rhs_weap_pkp','','','rhs_acc_1p78',['rhs_100Rnd_762x54mmR',100],[],''],[],['rhs_weap_pya','','','',['rhs_mag_9x19_17',17],[],''],['BNB_EX_Surpat_Gear_Camo_Unf_R',[['FirstAidKit',6]]],['CUP_V_B_Ciras_Olive2',[['rhs_mag_9x19_17',4,17],['rhs_100Rnd_762x54mmR',3,100],['rhs_mag_rgo',2,1],['rhs_mag_rdg2_white',2,1],['rhs_mag_rdg2_black',1,1]]],[],'rhs_altyn_novisor_ess_bala','',['Binocular','','','',[],[],''],['ItemMap','','ItemRadio','ItemCompass','ItemWatch','rhs_1PN138']];reload _unit;};[_unit] call _onSpawn;_unit addMPEventHandler ['MPRespawn', _onSpawn];};";
			};
		};
	...
	class BNB_FA_RS_Recon : O_Spotter_F_OCimport_02 {
		...
		class EventHandlers : EventHandlers {
			...
			class ALiVE_orbatCreator {
				init = "if (local (_this select 0)) then {_unit = _this select 0;_onSpawn = {_unit = _this select 0;_unit setUnitLoadout [['rhs_weap_aks74un','rhs_acc_pbs4','','',['rhs_30Rnd_545x39_AK',30],[],''],[],['rhs_weap_tr8','','','',[],[],''],['BNB_EX_Surpat_Gear_Camo_Unf',[['FirstAidKit',6]]],['CUP_V_CPC_lightbelt_rngr',[['rhs_30Rnd_545x39_7U1_AK',12,30],['rhs_mag_rgn',2,1],['rhs_mag_rdg2_white',2,1],['rhs_mag_rdg2_black',1,1]]],[],'rhsusf_opscore_rg_cover','',['Rangefinder','','','',[],[],''],['ItemMap','ItemGPS','ItemRadio','ItemCompass','ItemWatch','rhs_1PN138']];reload _unit;};[_unit] call _onSpawn;_unit addMPEventHandler ['MPRespawn', _onSpawn];};";
			};
		};
	...
	class BNB_FA_RS_SSO_Autorifleman : BNB_FA_RS_Autorifleman {
		...
		class EventHandlers : EventHandlers {
			...
			class ALiVE_orbatCreator {
				init = "if (local (_this select 0)) then {_unit = _this select 0;_onSpawn = {_unit = _this select 0;_unit setUnitLoadout [['rhs_weap_pkp','','','rhs_acc_1p78',['rhs_100Rnd_762x54mmR',100],[],''],[],['rhs_weap_pya','','','',['rhs_mag_9x19_17',17],[],''],['CUP_U_CRYE_MCAM_RUS_Full',[['FirstAidKit',6]]],['CUP_V_CPC_weaponsbelt_mc',[['rhs_mag_9x19_17',4,17],['rhs_100Rnd_762x54mmR',3,100],['rhs_mag_rgo',2,1],['rhs_mag_rdg2_white',2,1],['rhs_mag_rdg2_black',1,1]]],[],'rhsusf_opscore_coy_cover_pelt','',['Binocular','','','',[],[],''],['ItemMap','','ItemRadio','ItemCompass','ItemWatch','rhs_1PN138']];reload _unit;};[_unit] call _onSpawn;_unit addMPEventHandler ['MPRespawn', _onSpawn];};";
			};
		};
	...
	class BNB_FA_RS_SSO_Fireteam_Leader : BNB_FA_RS_Fireteam_Leader {
		...
		class EventHandlers : EventHandlers {
			...
			class ALiVE_orbatCreator {
				init = "if (local (_this select 0)) then {_unit = _this select 0;_onSpawn = {_unit = _this select 0;_unit setUnitLoadout [['rhs_weap_ak103_zenitco01','rhs_acc_dtk','','rhs_acc_pkas',['rhs_30Rnd_762x39mm',30],[],''],[],['rhs_weap_pya','','','',['rhs_mag_9x19_17',17],[],''],['CUP_U_CRYE_MCAM_RUS2_Roll',[['FirstAidKit',6]]],['CUP_V_CPC_weaponsbelt_mc',[['rhs_mag_9x19_17',4,17],['rhs_mag_rgo',2,1],['rhs_mag_rdg2_white',2,1],['rhs_mag_rdg2_black',1,1],['rhs_mag_fakels',2,1],['rhs_30Rnd_762x39mm',8,30]]],[],'rhsusf_opscore_mc_cover_pelt_cam','',['Binocular','','','',[],[],''],['ItemMap','ItemGPS','ItemRadio','ItemCompass','ItemWatch','rhs_1PN138']];reload _unit;};[_unit] call _onSpawn;_unit addMPEventHandler ['MPRespawn', _onSpawn];};";
			};
		};
	...
	class BNB_FA_RS_SSO_Medic : BNB_FA_RS_Medic {
		...
		class EventHandlers : EventHandlers {
			...
			class ALiVE_orbatCreator {
				init = "if (local (_this select 0)) then {_unit = _this select 0;_onSpawn = {_unit = _this select 0;_unit setUnitLoadout [['rhs_weap_ak103_zenitco01_b33','rhs_acc_dtk','rhs_acc_perst3','rhs_acc_rakursPM',['rhs_30Rnd_762x39mm',30],[],''],[],['rhs_weap_pya','','','',['rhs_mag_9x19_17',17],[],''],['CUP_U_CRYE_MCAM_RUS2_Roll',[['FirstAidKit',6]]],['CUP_V_CPC_Fastbelt_mc',[['rhs_30Rnd_762x39mm',10,30],['rhs_mag_9x19_17',4,17],['rhs_mag_rgo',2,1],['rhs_mag_nspn_green',1,1],['rhs_mag_fakel',2,1]]],['I_Fieldpack_oli_Medic',[['Medikit',1],['FirstAidKit',10]]],'rhsusf_opscore_mc_cover_pelt_cam','G_Combat',[],['ItemMap','','ItemRadio','ItemCompass','ItemWatch','rhs_1PN138']];reload _unit;};[_unit] call _onSpawn;_unit addMPEventHandler ['MPRespawn', _onSpawn];};";
			};
		};
	...
	class BNB_FA_RS_SSO_Rifleman_AT : BNB_FA_RS_Rifleman_AT {
		...
		class EventHandlers : EventHandlers {
			...
			class ALiVE_orbatCreator {
				init = "if (local (_this select 0)) then {_unit = _this select 0;_onSpawn = {_unit = _this select 0;_unit setUnitLoadout [['rhs_weap_ak74m_zenitco01','rhs_acc_dtk','rhs_acc_perst3','',['rhs_30Rnd_545x39_AK',30],[],'rhs_acc_grip_ffg2'],['rhs_weap_rpg26','','','',['rhs_rpg26_mag',1],[],''],['rhs_weap_pya','','','',['rhs_mag_9x19_17',17],[],''],['CUP_U_CRYE_MCAM_RUS_Roll',[['FirstAidKit',4],['rhs_1PN138',1]]],['CUP_V_CPC_Fastbelt_mc',[['rhs_mag_9x19_17',4,17],['rhs_30Rnd_545x39_AK',10,30],['rhs_mag_rgo',2,1],['rhs_mag_rdg2_white',2,1]]],[],'rhs_6b7_1m_bala2_olive','',[],['ItemMap','','ItemRadio','ItemCompass','ItemWatch','']];reload _unit;};[_unit] call _onSpawn;_unit addMPEventHandler ['MPRespawn', _onSpawn];};";
			};
		};
	...
	class BNB_FA_RS_SSO_Squad_Leader : rhs_msv_emr_sergeant_OCimport_02 {
		...
		class EventHandlers : EventHandlers {
			...
			class ALiVE_orbatCreator {
				init = "if (local (_this select 0)) then {_unit = _this select 0;_onSpawn = {_unit = _this select 0;_unit setUnitLoadout [['rhs_weap_ak103_zenitco01_b33','rhs_acc_dtk3','rhs_acc_perst3','rhsusf_acc_SpecterDR_A',['rhs_30Rnd_762x39mm',30],[],''],[],['rhs_weap_pya','','','',['rhs_mag_9x19_17',17],[],''],['CUP_U_CRYE_MCAM_NP2_Roll',[['FirstAidKit',6]]],['CUP_V_CPC_Fastbelt_mc',[['O_IR_Grenade',1,1],['rhs_30Rnd_762x39mm',10,30],['rhs_mag_9x19_17',4,17],['rhs_mag_rgn',2,1],['rhs_mag_rdg2_white',1,1]]],[],'rhsusf_opscore_mc_cover_pelt','G_Shades_Green',['rhs_pdu4','','','',[],[],''],['ItemMap','ItemGPS','ItemRadio','ItemCompass','ItemWatch','rhs_1PN138']];reload _unit;};[_unit] call _onSpawn;_unit addMPEventHandler ['MPRespawn', _onSpawn];};";
			};
		};
	...
	class BNB_FA_RS_SSO_Sniper : BNB_FA_RS_Sniper {
		...
		class EventHandlers : EventHandlers {
			...
			class ALiVE_orbatCreator {
				init = "if (local (_this select 0)) then {_unit = _this select 0;_onSpawn = {_unit = _this select 0;_unit setUnitLoadout [['rhs_weap_t5000','','','rhs_acc_dh520x56',['rhs_5Rnd_338lapua_t5000',5],[],'rhs_acc_harris_swivel'],[],['rhsusf_weap_glock17g4','','','',['rhsusf_mag_17Rnd_9x19_JHP',17],[],''],['CUP_U_CRYE_MCAM_RUS2_Roll',[['FirstAidKit',5],['SmokeShell',2,1],['rhsusf_mag_17Rnd_9x19_JHP',3,17]]],['CUP_V_B_Ciras_Khaki4',[['O_IR_Grenade',1,1],['rhs_5Rnd_338lapua_t5000',12,5],['rhs_mag_rgn',2,1],['rhs_mag_rdg2_white',2,1],['rhs_mag_rdg2_black',1,1]]],[],'rhsusf_opscore_mc_cover_pelt','',['rhs_pdu4','','','',[],[],''],['ItemMap','ItemGPS','ItemRadio','ItemCompass','ItemWatch','rhs_1PN138']];reload _unit;};[_unit] call _onSpawn;_unit addMPEventHandler ['MPRespawn', _onSpawn];};";
			};
		};
	...
	class BNB_FA_RS_SSO_Spotter : BNB_FA_RS_Spotter {
		...
		class EventHandlers : EventHandlers {
			...
			class ALiVE_orbatCreator {
				init = "if (local (_this select 0)) then {_unit = _this select 0;_onSpawn = {_unit = _this select 0;_unit setUnitLoadout [['rhs_weap_ak74mr','rhs_acc_tgpa','rhs_acc_perst3','rhsusf_acc_SpecterDR',['rhs_30Rnd_545x39_AK',30],[],'rhs_acc_grip_rk6'],[],['rhsusf_weap_glock17g4','','','',['rhsusf_mag_17Rnd_9x19_JHP',17],[],''],['CUP_U_CRYE_MCAM_RUS2_Roll',[['FirstAidKit',5],['SmokeShell',2,1],['rhsusf_mag_17Rnd_9x19_JHP',3,17]]],['CUP_V_B_Ciras_Khaki4',[['O_IR_Grenade',2,1],['rhs_30Rnd_545x39_AK',10,30],['rhs_mag_rgn',1,1],['rhs_mag_rdg2_white',2,1]]],[],'CUP_H_PMC_Cap_PRR_Tan','',['Rangefinder','','','',[],[],''],['ItemMap','ItemGPS','ItemRadio','ItemCompass','ItemWatch','rhs_1PN138']];reload _unit;};[_unit] call _onSpawn;_unit addMPEventHandler ['MPRespawn', _onSpawn];};";
			};
		};
