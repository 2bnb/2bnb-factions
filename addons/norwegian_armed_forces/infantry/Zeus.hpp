class BNB_FA_NAF_Zeus_Arctic : BNB_FA_NAF_Man_Arctic {
	displayName = "Zeus";
	editorPreview = "\x\bnb_fa\norwegian_armed_forces\data\preview\BNB_FA_NAF_Zeus_Arctic.jpg";
	icon = "iconManOfficer";
	...
	linkedItems[] = {"BNB_EX_Gear_Unit_Berret","ItemMap","ItemCompass","ACE_Altimeter","ItemRadio","ItemGPS"};
	respawnLinkedItems[] = {"BNB_EX_Gear_Unit_Berret","ItemMap","ItemCompass","ACE_Altimeter","ItemRadio","ItemGPS"};
};

class BNB_FA_NAF_Zeus_Desert : BNB_FA_NAF_Man_Desert {
	displayName = "Zeus";
	editorPreview = "\x\bnb_fa\norwegian_armed_forces\data\preview\BNB_FA_NAF_Zeus_Desert.jpg";
	icon = "iconManOfficer";
...
class BNB_FA_NAF_Zeus_Multicam : BNB_FA_NAF_Man_Multicam {
	displayName = "Zeus";
	editorPreview = "\x\bnb_fa\norwegian_armed_forces\data\preview\BNB_FA_NAF_Zeus_Multicam.jpg";
	icon = "iconManOfficer";
...
class BNB_FA_NAF_Zeus_Woodland : BNB_FA_NAF_Man_Woodland {
	displayName = "Zeus";
	editorPreview = "\x\bnb_fa\norwegian_armed_forces\data\preview\BNB_FA_NAF_Zeus_Woodland.jpg";
	icon = "iconManOfficer";
