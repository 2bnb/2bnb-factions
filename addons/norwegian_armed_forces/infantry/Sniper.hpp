class BNB_FA_NAF_Sniper_Arctic : BNB_FA_NAF_Recon_Rifleman_Arctic {
	displayName = "Sniper";
	editorPreview = "\x\bnb_fa\norwegian_armed_forces\data\preview\BNB_FA_NAF_Sniper_Arctic.jpg";
	...
	linkedItems[] = {"V_mas_nor_PlateCarrierLR_wint","H_mas_nor_opscore_w","G_mas_fra_Bandanna_W","ItemMap","ItemCompass","ACE_Altimeter","ItemRadio","ItemGPS"};
	respawnLinkedItems[] = {"V_mas_nor_PlateCarrierLR_wint","H_mas_nor_opscore_w","G_mas_fra_Bandanna_W","ItemMap","ItemCompass","ACE_Altimeter","ItemRadio","ItemGPS"};
};

class BNB_FA_NAF_Sniper_Desert : BNB_FA_NAF_Recon_Rifleman_Desert {
	displayName = "Sniper";
	editorPreview = "\x\bnb_fa\norwegian_armed_forces\data\preview\BNB_FA_NAF_Sniper_Desert.jpg";
...
class BNB_FA_NAF_Sniper_Multicam : BNB_FA_NAF_Recon_Rifleman_Multicam {
	displayName = "Sniper";
	editorPreview = "\x\bnb_fa\norwegian_armed_forces\data\preview\BNB_FA_NAF_Sniper_Multicam.jpg";
...
class BNB_FA_NAF_Sniper_Woodland : BNB_FA_NAF_Recon_Rifleman_Woodland {
	displayName = "Sniper";
	editorPreview = "\x\bnb_fa\norwegian_armed_forces\data\preview\BNB_FA_NAF_Sniper_Woodland.jpg";
