class BNB_FA_NAF_Engineer_EOD_Arctic : BNB_FA_NAF_Rifleman_Arctic {
	displayName = "Engineer/EOD";
	editorPreview = "\x\bnb_fa\norwegian_armed_forces\data\preview\BNB_FA_NAF_Engineer_EOD_Arctic.jpg";
...
class BNB_FA_NAF_Engineer_EOD_Desert : BNB_FA_NAF_Rifleman_Desert {
	displayName = "Engineer/EOD";
	editorPreview = "\x\bnb_fa\norwegian_armed_forces\data\preview\BNB_FA_NAF_Engineer_EOD_Desert.jpg";
	icon = "iconManEngineer";
	picture = "pictureRepair";
...
class BNB_FA_NAF_Engineer_EOD_Multicam : BNB_FA_NAF_Rifleman_Multicam {
	displayName = "Engineer/EOD";
	editorPreview = "\x\bnb_fa\norwegian_armed_forces\data\preview\BNB_FA_NAF_Engineer_EOD_Multicam.jpg";
	icon = "iconManEngineer";
	picture = "pictureRepair";
...
class BNB_FA_NAF_Engineer_EOD_Woodland : BNB_FA_NAF_Rifleman_Woodland {
	displayName = "Engineer/EOD";
	editorPreview = "\x\bnb_fa\norwegian_armed_forces\data\preview\BNB_FA_NAF_Engineer_EOD_Woodland.jpg";
	icon = "iconManEngineer";
	picture = "pictureRepair";
