class BNB_FA_JPN_Man_Jeitai_D : BNB_FA_JPN_Man {
	...
	linkedItems[] = {"Japan_JP_Jeitai_D_Helmet","ItemMap","ItemCompass","ItemWatch","ItemRadio"};
	respawnLinkedItems[] = {"Japan_JP_Jeitai_D_Helmet","ItemMap","ItemCompass","ItemWatch","ItemRadio"};
};

class BNB_FA_JPN_Man_Winter : BNB_FA_JPN_Man {
	displayName = "Man";
	// editorPreview = "\x\bnb_fa\norwegian_armed_forces\data\preview\BNB_FA_BW2_Man_Tropen.jpg";
	...
	linkedItems[] = {"Japan_JP_Pattern_Digital_Helmet","ItemMap","ItemCompass","ItemWatch","ItemRadio"};
	respawnLinkedItems[] = {"Japan_JP_Pattern_Digital_Helmet","ItemMap","ItemCompass","ItemWatch","ItemRadio"};
};

class BNB_FA_JPN_Man_Navy : BNB_FA_JPN_Man {
	displayName = "Man";
	// editorPreview = "\x\bnb_fa\norwegian_armed_forces\data\preview\BNB_FA_BW2_Man_Tropen.jpg";
	...
	linkedItems[] = {"Japan_JP_Pattern_Navy_Helmet","ItemMap","ItemCompass","ItemWatch","ItemRadio"};
	respawnLinkedItems[] = {"Japan_JP_Pattern_Navy_Helmet","ItemMap","ItemCompass","ItemWatch","ItemRadio"};
};

class BNB_FA_JPN_Man_Jeitai : BNB_FA_JPN_Man {
	displayName = "Man";
	// editorPreview = "\x\bnb_fa\norwegian_armed_forces\data\preview\BNB_FA_BW2_Man_Tropen.jpg";
