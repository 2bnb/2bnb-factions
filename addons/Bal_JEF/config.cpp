...
class CfgPatches {
	class BNB_FA_Bal {
		...
		units[] = {"BNB_FA_Bal_Rifleman_Woodland","BNB_FA_Bal_Medic_Woodland","BNB_FA_Bal_IC_Woodland","BNB_FA_Bal_Rifleman_Desert","BNB_FA_Bal_Medic_Desert","BNB_FA_Bal_IC_Desert","BNB_FA_Bal_Rifleman_MTP","BNB_FA_Bal_Medic_MTP","BNB_FA_Bal_IC_MTP","BNB_FA_Bal_Rifleman_Winter","BNB_FA_Bal_Medic_Winter","BNB_FA_Bal_IC_Winter"};
		weapons[] = {};
		magazines[] = {};
		ammo[] = {};
		worlds[] = {};
