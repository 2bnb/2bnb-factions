...
class B_NorwayArmy_Man_Woodland : B_NorwayArmy_Man {
	displayName = "Man";
	editorPreview = "\x\bnb_fa\bnorway\data\preview\B_NorwayArmy_Man_Woodland.jpg";
...
class B_NorwayArmy_Rifleman_Woodland : B_NorwayArmy_Man_Woodland {
	...
	editorPreview = "\x\bnb_fa\bnorway\data\preview\B_NorwayArmy_Rifleman_Woodland.jpg";
...
class B_NorwayArmy_Rifleman_AT_Woodland : B_NorwayArmy_Man_Woodland {
	...
	editorPreview = "\x\bnb_fa\bnorway\data\preview\B_NorwayArmy_Rifleman_AT_Woodland.jpg";
	icon = "iconManAT";
...
class B_NorwayArmy_Engineer_EOD_Woodland : B_NorwayArmy_Man_Woodland {
	...
	editorPreview = "\x\bnb_fa\bnorway\data\preview\B_NorwayArmy_Engineer_EOD_Woodland.jpg";
...
class B_NorwayArmy_1IC_Woodland : B_NorwayArmy_Man_Woodland {
	displayName = "1IC";
	editorPreview = "\x\bnb_fa\bnorway\data\preview\B_NorwayArmy_IC_2IC_Woodland.jpg";
	icon = "iconManOfficer";
...
class B_NorwayArmy_Marksman_Woodland : B_NorwayArmy_Man_Woodland {
	...
	editorPreview = "\x\bnb_fa\bnorway\data\preview\B_NorwayArmy_Marksman_Woodland.jpg";

	bnb_fa_weaponItems[] = {"muzzle_snds_B","","rhsusf_acc_su230a_mrds","bipod_01_F_blk"};
...
class B_NorwayArmy_LMG_556_Woodland : B_NorwayArmy_Man_Woodland {
	...
	editorPreview = "\x\bnb_fa\bnorway\data\preview\B_NorwayArmy_LMG_556_Woodland.jpg";
	icon = "iconManMG";
...
class B_NorwayArmy_LMG_762_Woodland : B_NorwayArmy_Man_Woodland {
	...
	editorPreview = "\x\bnb_fa\bnorway\data\preview\B_NorwayArmy_LMG_762_Woodland.jpg";
	icon = "iconManMG";
...
class B_NorwayArmy_Medic_Woodland : B_NorwayArmy_Man_Woodland {
	displayName = "Medic";
	editorPreview = "\x\bnb_fa\bnorway\data\preview\B_NorwayArmy_Medic_Woodland.jpg";
	icon = "iconManMedic";
	picture = "pictureHeal";
...
class B_NorwayArmy_Crew_Woodland : B_NorwayArmy_Man_Woodland {
	author = "Jebby";
	displayName = "Crew";
	editorPreview = "\x\bnb_fa\bnorway\data\preview\B_NorwayArmy_Crew_Woodland.jpg";

	bnb_fa_weaponItems[] = {"","","optic_Yorris",""};
...
class B_NorwayArmy_Pilot_Woodland : B_NorwayArmy_Man_Woodland {
	author = "Jebby";
	displayName = "Pilot";
	editorPreview = "\x\bnb_fa\bnorway\data\preview\B_NorwayArmy_Pilot_Woodland.jpg";
...
class B_NorwayArmy_Recon_IC_Woodland : B_NorwayArmy_Man_Woodland {
	...
	editorPreview = "\x\bnb_fa\bnorway\data\preview\B_NorwayArmy_Recon_IC_Woodland.jpg";
	icon = "iconManOfficer";

	bnb_fa_weaponItems[] = {"muzzle_snds_B","","rhsusf_acc_g33_xps3",""};
...
class B_NorwayArmy_Recon_Rifleman_Woodland : B_NorwayArmy_Man_Woodland {
	...
	editorPreview = "\x\bnb_fa\bnorway\data\preview\B_NorwayArmy_Recon_Rifleman_Woodland.jpg";

	bnb_fa_weaponItems[] = {"muzzle_snds_B","","rhsusf_acc_g33_xps3","rhsusf_acc_harris_bipod"};
...
class B_NorwayArmy_Sniper_Woodland : B_NorwayArmy_Man_Woodland {
	displayName = "Sniper";
	editorPreview = "\x\bnb_fa\bnorway\data\preview\B_NorwayArmy_Sniper_Woodland.jpg";

	bnb_fa_weaponItems[] = {"","","rhsusf_acc_LEUPOLDMK4_2",""};
...
class B_NorwayArmy_Spotter_Woodland : B_NorwayArmy_Man_Woodland {
	displayName = "Spotter";
	editorPreview = "\x\bnb_fa\bnorway\data\preview\B_NorwayArmy_Spotter_Woodland.jpg";
...
class B_NorwayArmy_Zeus_Woodland : B_NorwayArmy_Man_Woodland {
	displayName = "Zeus";
	editorPreview = "\x\bnb_fa\bnorway\data\preview\B_NorwayArmy_Zeus_Woodland.jpg";
	icon = "iconManOfficer";
...
class B_NorwayArmy_Leopard_2SG_Woodland : B_NorwayArmy_Leopard {
	...
	hiddenSelectionsTextures[] = {
		"\x\bnb_fa\bnorway\data\textures\Leopard_Woodland_Hull.paa", // Hull
		"\x\bnb_fa\bnorway\data\textures\Leopard_Woodland_Main_Turret.paa", // Main Turret
		"\x\bnb_fa\bnorway\data\textures\Leopard_Woodland_Com_Turret.paa", // Commander Turret
...
class B_NorwayArmy_Leopard_2SG_Kompis_Woodland : B_NorwayArmy_Leopard {
	...
	hiddenSelections[] = {"Camo1","Camo2","Camo3","CamoNet"};
	hiddenSelectionsTextures[] = {
		"\x\bnb_fa\bnorway\data\textures\Leopard_Kompis_Hull.paa", // Hull
		"\x\bnb_fa\bnorway\data\textures\Leopard_Kompis_Main_Turret.paa", // Main Turret
		"\x\bnb_fa\bnorway\data\textures\Leopard_Kompis_Com_Turret.paa", // Commander Turret
		"A3\Armor_F\Data\camonet_greenbeige_co.paa"
	};
};
...
class B_NorwayArmy_Scania_Fuel_Woodland : B_NorwayArmy_Scania_Fuel {
	...
	hiddenSelectionsTextures[] = {
		"\x\bnb_fa\bnorway\data\textures\Scania_Woodland_Front.paa", // Front
		"\x\bnb_fa\bnorway\data\textures\Scania_Woodland_Fuel.paa", // Canopy
		"\x\bnb_fa\bnorway\data\textures\Scania_Interior.paa" // Interior
	};
};
...
class B_NorwayArmy_JAS_39_Gripen_Woodland : I_Plane_Fighter_04_F_OCimport_02 {
	...
	hiddenSelectionsTextures[] = {
		"x\bnb_fa\bnorway\data\textures\Gripen_fuselage_01_co.paa",
		"x\bnb_fa\bnorway\data\textures\Gripen_fuselage_02_co.paa"
	};
