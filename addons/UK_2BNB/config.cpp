class CfgPatches {
	class BNB_FA_UK {
		...
		units[] = {"BNB_FA_UK_Rifleman_Woodland","BNB_FA_UK_Medic_Woodland","BNB_FA_UK_IC_Woodland","BNB_FA_UK_Rifleman_Desert","BNB_FA_UK_Medic_Desert","BNB_FA_UK_IC_Desert","BNB_FA_UK_Rifleman_MTP","BNB_FA_UK_Medic_MTP","BNB_FA_UK_IC_MTP","BNB_FA_UK_Rifleman_Winter","BNB_FA_UK_Medic_Winter","BNB_FA_UK_IC_Winter"};
		weapons[] = {};
		magazines[] = {};
		ammo[] = {};
		worlds[] = {};
