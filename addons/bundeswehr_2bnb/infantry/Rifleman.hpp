class BNB_FA_BW2_Rifleman_Tropen : BNB_FA_BW2_Man_Tropen {
	displayName = "Rifleman";
	// editorPreview = "\x\bnb_fa\norwegian_armed_forces\data\preview\BNB_FA_BW2_Rifleman_Tropen.jpg";
	editorSubcategory = "BNB_FA_BW2_Infantry_Section";
...
class BNB_FA_BW2_Rifleman_Winter : BNB_FA_BW2_Rifleman_Tropen {
	faction = "BNB_FA_BW2_Winter";
};

class BNB_FA_BW2_Rifleman_Multi : BNB_FA_BW2_Man_Multi {
	displayName = "Rifleman";
	// editorPreview = "\x\bnb_fa\norwegian_armed_forces\data\preview\BNB_FA_BW2_Rifleman_Multi.jpg";
	editorSubcategory = "BNB_FA_BW2_Infantry_Section";
...
class BNB_FA_BW2_Rifleman_Fleck : BNB_FA_BW2_Man_Fleck {
	displayName = "Rifleman";
	// editorPreview = "\x\bnb_fa\norwegian_armed_forces\data\preview\BNB_FA_BW2_Rifleman_Fleck.jpg";
	editorSubcategory = "BNB_FA_BW2_Infantry_Section";
